<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="DentalFinal.ContactUs" %>
                ...
                <div class="col-lg-6  px-lg-5 map contact-right">
                    <div class="address">
                        ...
                        <div class="row py-3 wthree-cicon">
                            <a href="mailto:girishph@gmail.com">girish@gmail.com</a><br />
&nbsp;dolyang7@gmail.com</div>
                        <div class="row py-3  wthree-cicon">
                ...
                <div class="col-lg-6 wthree-form-left mt-lg-0 mt-3">
                    ...
                    <div class="contact-top1">
                        <h5 class="my-3" aria-checked="false">send us a message</h5>
